...
def predict_future_sales():
    try:
        # Load and clean data from the vgchartz CSV file
        ...
        # Customize the plot
        plt.title('Global Video Game Sales Prediction (VGChartz 2024 Data)\n(Historical Data and 5-Year Forecast)', 
                 fontsize=16, fontweight='bold', pad=20)
        plt.xlabel('Year', fontsize=12, fontweight='bold')
        plt.ylabel('Total Sales (millions of units)', fontsize=12, fontweight='bold')
        ...
        plt.savefig('sales_prediction_vgchartz.png', dpi=300, bbox_inches='tight')
        print(f"\nPlot saved as 'sales_prediction_vgchartz.png'")
...
if __name__ == "__main__":
    print("Video Game Sales Prediction Analysis (VGChartz 2024 Data)")
    print("=" * 55)
    model, historical_data, future_years, predictions = predict_future_sales()
    
    if model is not None:
        print("\nAnalysis completed successfully!")
        print("Check the 'sales_prediction_vgchartz.png' file for the visualization.")
